...
describe("password validation", function(){
    ...
    it("should not allow tabs", function(){
        expect(isValidPassword("123456  7890ab")).toBe(false);
    });

    it("should require at least one digit", function(){
        expect(isValidPassword("aaaaaaaaaaaa")).toBe(false);
    });

    it("should require at least one letter", function(){
        expect(isValidPassword("111111111111")).toBe(false);
    });

    it("should require at least one symbol", function(){
